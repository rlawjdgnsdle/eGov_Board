...
public class BoardController {
	...
	@Autowired ArticleDTO article;  // 싱글톤에있는걸 GETINSTANCE 한것?
	@Autowired BoardService boardservice;  // 싱글톤에있는걸 GETINSTANCE 한것?
	...
	public String login(
		...
		p.put("memid", memid);
		MemberDTO m = /*memberSerivce.retrieve(p);*/null; 
		logger.info("============================");
